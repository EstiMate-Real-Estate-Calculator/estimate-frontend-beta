...
const SplashNavBar = () => {
  ...
  return (
    <nav className="flex w-full flex-row items-center justify-between bg-transparent px-2 py-8 md:px-20">
      ...
      <div className="rounded-md px-3 py-2 text-lg text-light-body space-x-4">
        <a
        ...
        <a href="/FAQ" className="rounded-md px-3 py-2">
          FAQ
        </a>
        <a
        ...
        <a href="/sign-in" className="rounded-md px-3 py-2 text-light-primary">
          Login
        </a>
        <a
          href="/payment"
          className="rounded-md bg-light-primary px-3 py-2 text-white hover:bg-light-primary_light"
        >
          Sign Up
        </a>
      </div>
      ...
      <div className="absolute right-2 top-10 flex items-center md:hidden">
        <button
          className={`inline-flex items-center justify-center rounded-md p-2 text-light-body hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white ${
      ...
      <div
        className={`fixed inset-0 z-20 bg-gray-800 bg-opacity-75 transition-opacity ${
